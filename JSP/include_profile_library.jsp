...
<html>
	...
	<%
		...
		while(rs.next())
		{
			...
			out.print("</br><p>Issue Date: "+rs.getString("issue_date")+"</p>");
			out.print("<p>Return Date: "+rs.getString("return_date")+"</p>");
			out.print("<p><a href=\"JSP/return_book.jsp?book_id="+rs.getString("book_id")+"\" >Return Book</a></p></td>");
			out.print("</tr>");
			out.print("</table></br>");
			out.print("</a>");
		}
